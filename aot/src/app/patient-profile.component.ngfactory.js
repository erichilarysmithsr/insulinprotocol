...
export { Wrapper_PatientProfileComponent };
...
var View_PatientProfileComponent_Host0 = (function (_super) {
    ...
    function View_PatientProfileComponent_Host0(viewUtils, parentView, parentIndex, parentElement) {
        return _super.call(this, View_PatientProfileComponent_Host0, renderType_PatientProfileComponent_Host, import5.ViewType.HOST, viewUtils, parentView, parentIndex, parentElement, import6.ChangeDetectorStatus.CheckAlways) || this;
    }
...
var View_PatientProfileComponent2 = (function (_super) {
    __extends(View_PatientProfileComponent2, _super);
    function View_PatientProfileComponent2(viewUtils, parentView, parentIndex, parentElement, declaredViewContainer) {
        var _this = _super.call(this, View_PatientProfileComponent2, renderType_PatientProfileComponent, import5.ViewType.EMBEDDED, viewUtils, parentView, parentIndex, parentElement, import6.ChangeDetectorStatus.CheckAlways, declaredViewContainer) || this;
        _this._expr_5 = import16.UNINITIALIZED;
        return _this;
    }
    View_PatientProfileComponent2.prototype.createInternal = function (rootSelector) {
        this._el_0 = import3.createRenderElement(this.renderer, null, 'md-option', new import3.InlineArray2(2, 'role', 'option'), null);
        ...
        this._MdPrefixRejector_0_4 = new import14.Wrapper_MdPrefixRejector(this.parentView.parentView.parentView.injectorGet(import18.MATERIAL_COMPATIBILITY_MODE, this.parentView.parentView.parentIndex, null));
    ...
    View_PatientProfileComponent2.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        if (((token === import12.MdOption) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 1)))) {
            return this._MdOption_0_3.context;
        }
        if (((token === import18.MdPrefixRejector) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 1)))) {
            return this._MdPrefixRejector_0_4.context;
        }
        return notFoundResult;
    };
    View_PatientProfileComponent2.prototype.detectChangesInternal = function (throwOnChange) {
        var currVal_0_0_0 = this.context.$implicit.k;
        ...
        var currVal_5 = import3.inlineInterpolate(1, '', this.context.$implicit.t, '');
    ...
    View_PatientProfileComponent2.prototype.dirtyParentQueriesInternal = function () {
        this.parentView._query_MdOption_0_0.setDirty();
    };
    View_PatientProfileComponent2.prototype.destroyInternal = function () {
        this.compView_0.destroy();
        this._MdOption_0_3.ngOnDestroy();
    };
    View_PatientProfileComponent2.prototype.visitRootNodesInternal = function (cb, ctx) {
        cb(this._el_0, ctx);
    };
    View_PatientProfileComponent2.prototype.visitProjectableNodesInternal = function (nodeIndex, ngContentIndex, cb, ctx) {
        if (((nodeIndex == 0) && (ngContentIndex == 0))) {
            cb(this._text_1, ctx);
        }
    };
    View_PatientProfileComponent2.prototype.handleEvent_0 = function (eventName, $event) {
        this.compView_0.markPathToRootAsCheckOnce();
        var result = true;
        result = (this._MdOption_0_3.handleEvent(eventName, $event) && result);
        return result;
    };
    return View_PatientProfileComponent2;
}(import1.AppView));
var View_PatientProfileComponent1 = (function (_super) {
    __extends(View_PatientProfileComponent1, _super);
    function View_PatientProfileComponent1(viewUtils, parentView, parentIndex, parentElement, declaredViewContainer) {
        return _super.call(this, View_PatientProfileComponent1, renderType_PatientProfileComponent, import5.ViewType.EMBEDDED, viewUtils, parentView, parentIndex, parentElement, import6.ChangeDetectorStatus.CheckAlways, declaredViewContainer) || this;
    }
    View_PatientProfileComponent1.prototype.createInternal = function (rootSelector) {
        this._el_0 = import3.createRenderElement(this.renderer, null, 'md-select', new import3.InlineArray16(10, 'class', 'medium', 'name', 'subcutaneousColumn', 'placeholder', 'Subcutaneous Column', 'required', '', 'role', 'listbox'), null);
        ...
        this._NgModel_0_5 = new import21.Wrapper_NgModel(this.parentView._ControlContainer_2_4, this._NG_VALIDATORS_0_4, null, null);
        ...
        this._MdPrefixRejector_0_8 = new import14.Wrapper_MdPrefixRejector(this.parentView.parentView.injectorGet(import18.MATERIAL_COMPATIBILITY_MODE, this.parentView.parentIndex, null));
        this._MdSelect_0_9 = new import23.Wrapper_MdSelect(new import17.ElementRef(this._el_0), this.renderer, this.parentView.parentView.injectorGet(import26.ViewportRuler, this.parentView.parentIndex), this.compView_0.ref, this.parentView.parentView.injectorGet(import27.Dir, this.parentView.parentIndex, null), this._NgControl_0_6);
        this._query_MdOption_0_0 = new import24.QueryList();
        ...
        var disposable_0 = import3.subscribeToRenderElement(this, this._el_0, new import3.InlineArray8(6, 'ngModelChange', null, 'keydown', null, 'blur', null), this.eventHandler(this.handleEvent_0));
    ...
    View_PatientProfileComponent1.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        if (((token === import28.TemplateRef) && (2 === requestNodeIndex))) {
            return this._TemplateRef_2_5;
        }
        if (((token === import30.NgFor) && (2 === requestNodeIndex))) {
            return this._NgFor_2_6.context;
        }
        if (((token === import31.RequiredValidator) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 3)))) {
            return this._RequiredValidator_0_3.context;
        }
        if (((token === import32.NG_VALIDATORS) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 3)))) {
            return this._NG_VALIDATORS_0_4;
        }
        if (((token === import33.NgModel) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 3)))) {
            return this._NgModel_0_5.context;
        }
        if (((token === import34.NgControl) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 3)))) {
            return this._NgControl_0_6;
        }
        if (((token === import35.NgControlStatus) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 3)))) {
            return this._NgControlStatus_0_7.context;
        }
        if (((token === import18.MdPrefixRejector) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 3)))) {
            return this._MdPrefixRejector_0_8.context;
        }
        if (((token === import19.MdSelect) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 3)))) {
            return this._MdSelect_0_9.context;
        }
        return notFoundResult;
    };
    View_PatientProfileComponent1.prototype.detectChangesInternal = function (throwOnChange) {
        var currVal_0_0_0 = '';
        ...
        var currVal_0_1_0 = 'subcutaneousColumn';
        this._NgModel_0_5.check_name(currVal_0_1_0, throwOnChange, false);
        var currVal_0_1_1 = this.parentView.context.pp.patient.profile.subcutaneousColumn;
        ...
        var currVal_0_4_0 = 'Subcutaneous Column';
        ...
        var currVal_2_0_0 = this.parentView.context.getOptions('subcutaneous');
        this._NgFor_2_6.check_ngForOf(currVal_2_0_0, throwOnChange, false);
        this._NgFor_2_6.ngDoCheck(this, this._anchor_2, throwOnChange);
        this._vc_2.detectChangesInNestedViews(throwOnChange);
        if (!throwOnChange) {
            if (this._query_MdOption_0_0.dirty) {
                this._query_MdOption_0_0.reset([this._vc_2.mapNestedViews(View_PatientProfileComponent2, function (nestedView) {
            ...
            if ((this.numberOfChecks === 0)) {
                this._MdSelect_0_9.context.ngAfterContentInit();
            }
        }
    ...
    View_PatientProfileComponent1.prototype.destroyInternal = function () {
        this._vc_2.destroyNestedViews();
        this.compView_0.destroy();
        this._NgModel_0_5.ngOnDestroy();
        this._MdSelect_0_9.ngOnDestroy();
    };
    View_PatientProfileComponent1.prototype.visitRootNodesInternal = function (cb, ctx) {
        cb(this._el_0, ctx);
    };
    View_PatientProfileComponent1.prototype.visitProjectableNodesInternal = function (nodeIndex, ngContentIndex, cb, ctx) {
        if (((nodeIndex == 0) && (ngContentIndex == 0))) {
            cb(this._text_1, ctx);
    ...
    View_PatientProfileComponent1.prototype.createEmbeddedViewInternal = function (nodeIndex) {
        if ((nodeIndex == 2)) {
            return new View_PatientProfileComponent2(this.viewUtils, this, 2, this._anchor_2, this._vc_2);
        }
        return null;
    };
    View_PatientProfileComponent1.prototype.handleEvent_0 = function (eventName, $event) {
        this.compView_0.markPathToRootAsCheckOnce();
        var result = true;
        result = (this._MdSelect_0_9.handleEvent(eventName, $event) && result);
        if ((eventName == 'ngModelChange')) {
            var pd_sub_0 = ((this.parentView.context.pp.patient.profile.subcutaneousColumn = $event) !== false);
            result = (pd_sub_0 && result);
        }
        return result;
    };
    return View_PatientProfileComponent1;
}(import1.AppView));
var View_PatientProfileComponent4 = (function (_super) {
    __extends(View_PatientProfileComponent4, _super);
    function View_PatientProfileComponent4(viewUtils, parentView, parentIndex, parentElement, declaredViewContainer) {
        var _this = _super.call(this, View_PatientProfileComponent4, renderType_PatientProfileComponent, import5.ViewType.EMBEDDED, viewUtils, parentView, parentIndex, parentElement, import6.ChangeDetectorStatus.CheckAlways, declaredViewContainer) || this;
        _this._expr_5 = import16.UNINITIALIZED;
        return _this;
    }
    View_PatientProfileComponent4.prototype.createInternal = function (rootSelector) {
        this._el_0 = import3.createRenderElement(this.renderer, null, 'md-option', new import3.InlineArray2(2, 'role', 'option'), null);
        this.compView_0 = new import13.View_MdOption0(this.viewUtils, this, 0, this._el_0);
        this._MdOption_0_3 = new import13.Wrapper_MdOption(new import17.ElementRef(this._el_0), this.renderer);
        this._MdPrefixRejector_0_4 = new import14.Wrapper_MdPrefixRejector(this.parentView.parentView.parentView.injectorGet(import18.MATERIAL_COMPATIBILITY_MODE, this.parentView.parentView.parentIndex, null));
    ...
    View_PatientProfileComponent4.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        if (((token === import12.MdOption) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 1)))) {
            return this._MdOption_0_3.context;
        }
        if (((token === import18.MdPrefixRejector) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 1)))) {
    ...
    View_PatientProfileComponent4.prototype.detectChangesInternal = function (throwOnChange) {
        var currVal_0_0_0 = this.context.$implicit.k;
        this._MdOption_0_3.check_value(currVal_0_0_0, throwOnChange, false);
        this._MdOption_0_3.ngDoCheck(this, this._el_0, throwOnChange);
        this._MdPrefixRejector_0_4.ngDoCheck(this, this._el_0, throwOnChange);
    ...
    View_PatientProfileComponent4.prototype.dirtyParentQueriesInternal = function () {
        this.parentView._query_MdOption_0_0.setDirty();
    };
    View_PatientProfileComponent4.prototype.destroyInternal = function () {
        this.compView_0.destroy();
        this._MdOption_0_3.ngOnDestroy();
    };
    View_PatientProfileComponent4.prototype.visitRootNodesInternal = function (cb, ctx) {
        cb(this._el_0, ctx);
    };
    View_PatientProfileComponent4.prototype.visitProjectableNodesInternal = function (nodeIndex, ngContentIndex, cb, ctx) {
        if (((nodeIndex == 0) && (ngContentIndex == 0))) {
            cb(this._text_1, ctx);
        }
    };
    View_PatientProfileComponent4.prototype.handleEvent_0 = function (eventName, $event) {
        this.compView_0.markPathToRootAsCheckOnce();
        var result = true;
        result = (this._MdOption_0_3.handleEvent(eventName, $event) && result);
        return result;
    };
    return View_PatientProfileComponent4;
}(import1.AppView));
var View_PatientProfileComponent3 = (function (_super) {
    __extends(View_PatientProfileComponent3, _super);
    function View_PatientProfileComponent3(viewUtils, parentView, parentIndex, parentElement, declaredViewContainer) {
        return _super.call(this, View_PatientProfileComponent3, renderType_PatientProfileComponent, import5.ViewType.EMBEDDED, viewUtils, parentView, parentIndex, parentElement, import6.ChangeDetectorStatus.CheckAlways, declaredViewContainer) || this;
    }
    View_PatientProfileComponent3.prototype.createInternal = function (rootSelector) {
        this._el_0 = import3.createRenderElement(this.renderer, null, 'md-select', new import3.InlineArray16(10, 'class', 'medium', 'name', 'infusionColumn', 'placeholder', 'Infusion Column', 'required', '', 'role', 'listbox'), null);
        this.compView_0 = new import23.View_MdSelect0(this.viewUtils, this, 0, this._el_0);
        this._RequiredValidator_0_3 = new import20.Wrapper_RequiredValidator();
        this._NG_VALIDATORS_0_4 = [this._RequiredValidator_0_3.context];
        this._NgModel_0_5 = new import21.Wrapper_NgModel(this.parentView._ControlContainer_2_4, this._NG_VALIDATORS_0_4, null, null);
    ...
    View_PatientProfileComponent3.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        if (((token === import28.TemplateRef) && (2 === requestNodeIndex))) {
            return this._TemplateRef_2_5;
        }
        if (((token === import30.NgFor) && (2 === requestNodeIndex))) {
    ...
    View_PatientProfileComponent3.prototype.detectChangesInternal = function (throwOnChange) {
        var currVal_0_0_0 = '';
        this._RequiredValidator_0_3.check_required(currVal_0_0_0, throwOnChange, false);
        this._RequiredValidator_0_3.ngDoCheck(this, this._el_0, throwOnChange);
        var currVal_0_1_0 = 'infusionColumn';
        this._NgModel_0_5.check_name(currVal_0_1_0, throwOnChange, false);
        var currVal_0_1_1 = this.parentView.context.pp.patient.profile.infusionColumn;
        this._NgModel_0_5.check_model(currVal_0_1_1, throwOnChange, false);
        this._NgModel_0_5.ngDoCheck(this, this._el_0, throwOnChange);
        this._NgControlStatus_0_7.ngDoCheck(this, this._el_0, throwOnChange);
        this._MdPrefixRejector_0_8.ngDoCheck(this, this._el_0, throwOnChange);
        var currVal_0_4_0 = 'Infusion Column';
        this._MdSelect_0_9.check_placeholder(currVal_0_4_0, throwOnChange, false);
        var currVal_0_4_1 = '';
        this._MdSelect_0_9.check_required(currVal_0_4_1, throwOnChange, false);
        this._MdSelect_0_9.ngDoCheck(this, this._el_0, throwOnChange);
        var currVal_2_0_0 = this.parentView.context.getOptions('infusion');
        this._NgFor_2_6.check_ngForOf(currVal_2_0_0, throwOnChange, false);
        this._NgFor_2_6.ngDoCheck(this, this._anchor_2, throwOnChange);
        this._vc_2.detectChangesInNestedViews(throwOnChange);
        if (!throwOnChange) {
            if (this._query_MdOption_0_0.dirty) {
                this._query_MdOption_0_0.reset([this._vc_2.mapNestedViews(View_PatientProfileComponent4, function (nestedView) {
                        return [nestedView._MdOption_0_3.context];
                    })]);
                this._MdSelect_0_9.context.options = this._query_MdOption_0_0;
                this._query_MdOption_0_0.notifyOnChanges();
    ...
    View_PatientProfileComponent3.prototype.destroyInternal = function () {
        this._vc_2.destroyNestedViews();
        this.compView_0.destroy();
        this._NgModel_0_5.ngOnDestroy();
        this._MdSelect_0_9.ngOnDestroy();
    };
    View_PatientProfileComponent3.prototype.visitRootNodesInternal = function (cb, ctx) {
        cb(this._el_0, ctx);
    };
    View_PatientProfileComponent3.prototype.visitProjectableNodesInternal = function (nodeIndex, ngContentIndex, cb, ctx) {
        if (((nodeIndex == 0) && (ngContentIndex == 0))) {
            cb(this._text_1, ctx);
            cb(this._vc_2.nativeElement, ctx);
            this._vc_2.visitNestedViewRootNodes(cb, ctx);
    ...
    View_PatientProfileComponent3.prototype.createEmbeddedViewInternal = function (nodeIndex) {
        if ((nodeIndex == 2)) {
            return new View_PatientProfileComponent4(this.viewUtils, this, 2, this._anchor_2, this._vc_2);
        }
        return null;
    };
    View_PatientProfileComponent3.prototype.handleEvent_0 = function (eventName, $event) {
        this.compView_0.markPathToRootAsCheckOnce();
        var result = true;
        result = (this._MdSelect_0_9.handleEvent(eventName, $event) && result);
        if ((eventName == 'ngModelChange')) {
            var pd_sub_0 = ((this.parentView.context.pp.patient.profile.infusionColumn = $event) !== false);
            result = (pd_sub_0 && result);
        }
        return result;
    };
    return View_PatientProfileComponent3;
}(import1.AppView));
...
var View_PatientProfileComponent0 = (function (_super) {
    ...
    function View_PatientProfileComponent0(viewUtils, parentView, parentIndex, parentElement) {
        return _super.call(this, View_PatientProfileComponent0, renderType_PatientProfileComponent, import5.ViewType.COMPONENT, viewUtils, parentView, parentIndex, parentElement, import6.ChangeDetectorStatus.CheckAlways) || this;
    }
    View_PatientProfileComponent0.prototype.createInternal = function (rootSelector) {
        ...
        this._NgForm_2_3 = new import36.Wrapper_NgForm(null, null);
        ...
        this._query_MdInputDirective_4_0 = new import24.QueryList();
        this._query_MdPlaceholder_4_1 = new import24.QueryList();
        this._query_MdHint_4_2 = new import24.QueryList();
        ...
        this._NgModel_6_7 = new import21.Wrapper_NgModel(this._ControlContainer_2_4, this._NG_VALIDATORS_6_5, null, this._NG_VALUE_ACCESSOR_6_6);
        ...
        this._query_MdInputDirective_9_0 = new import24.QueryList();
        this._query_MdPlaceholder_9_1 = new import24.QueryList();
        this._query_MdHint_9_2 = new import24.QueryList();
        ...
        this._NgModel_11_7 = new import21.Wrapper_NgModel(this._ControlContainer_2_4, this._NG_VALIDATORS_11_5, null, this._NG_VALUE_ACCESSOR_11_6);
        ...
        this._query_MdInputDirective_14_0 = new import24.QueryList();
        this._query_MdPlaceholder_14_1 = new import24.QueryList();
        this._query_MdHint_14_2 = new import24.QueryList();
        ...
        this._NgModel_16_7 = new import21.Wrapper_NgModel(this._ControlContainer_2_4, this._NG_VALIDATORS_16_5, null, this._NG_VALUE_ACCESSOR_16_6);
        ...
        this._query_MdInputDirective_19_0 = new import24.QueryList();
        this._query_MdPlaceholder_19_1 = new import24.QueryList();
        this._query_MdHint_19_2 = new import24.QueryList();
        ...
        this._NgModel_21_7 = new import21.Wrapper_NgModel(this._ControlContainer_2_4, this._NG_VALIDATORS_21_5, null, this._NG_VALUE_ACCESSOR_21_6);
        ...
        this._query_MdInputDirective_24_0 = new import24.QueryList();
        this._query_MdPlaceholder_24_1 = new import24.QueryList();
        this._query_MdHint_24_2 = new import24.QueryList();
        ...
        this._NgModel_26_8 = new import21.Wrapper_NgModel(this._ControlContainer_2_4, this._NG_VALIDATORS_26_6, null, this._NG_VALUE_ACCESSOR_26_7);
        ...
        this._NgModel_29_5 = new import21.Wrapper_NgModel(this._ControlContainer_2_4, this._NG_VALIDATORS_29_4, null, null);
        ...
        this._MdPrefixRejector_29_8 = new import14.Wrapper_MdPrefixRejector(this.parentView.injectorGet(import18.MATERIAL_COMPATIBILITY_MODE, this.parentIndex, null));
        this._MdSelect_29_9 = new import23.Wrapper_MdSelect(new import17.ElementRef(this._el_29), this.renderer, this.parentView.injectorGet(import26.ViewportRuler, this.parentIndex), this.compView_29.ref, this.parentView.injectorGet(import27.Dir, this.parentIndex, null), this._NgControl_29_6);
        this._query_MdOption_29_0 = new import24.QueryList();
        ...
        this._MdPrefixRejector_31_4 = new import14.Wrapper_MdPrefixRejector(this.parentView.injectorGet(import18.MATERIAL_COMPATIBILITY_MODE, this.parentIndex, null));
        ...
        this._MdPrefixRejector_34_4 = new import14.Wrapper_MdPrefixRejector(this.parentView.injectorGet(import18.MATERIAL_COMPATIBILITY_MODE, this.parentIndex, null));
        ...
        this._query_MdInputDirective_38_0 = new import24.QueryList();
        this._query_MdPlaceholder_38_1 = new import24.QueryList();
        this._query_MdHint_38_2 = new import24.QueryList();
        ...
        this._NgModel_40_8 = new import21.Wrapper_NgModel(this._ControlContainer_2_4, this._NG_VALIDATORS_40_6, null, this._NG_VALUE_ACCESSOR_40_7);
        ...
        this._el_43 = import3.createRenderElement(this.renderer, this._el_2, 'md-select', new import3.InlineArray16(10, 'class', 'medium', 'name', 'insulinDeliveryType', 'placeholder', 'Insulin Delivery Type', 'required', '', 'role', 'listbox'), null);
        ...
        this._NgModel_43_5 = new import21.Wrapper_NgModel(this._ControlContainer_2_4, this._NG_VALIDATORS_43_4, null, null);
        ...
        this._MdPrefixRejector_43_8 = new import14.Wrapper_MdPrefixRejector(this.parentView.injectorGet(import18.MATERIAL_COMPATIBILITY_MODE, this.parentIndex, null));
        this._MdSelect_43_9 = new import23.Wrapper_MdSelect(new import17.ElementRef(this._el_43), this.renderer, this.parentView.injectorGet(import26.ViewportRuler, this.parentIndex), this.compView_43.ref, this.parentView.injectorGet(import27.Dir, this.parentIndex, null), this._NgControl_43_6);
        this._query_MdOption_43_0 = new import24.QueryList();
        this._text_44 = this.renderer.createText(null, '\n			', null);
        this._el_45 = import3.createRenderElement(this.renderer, null, 'md-option', new import3.InlineArray4(4, 'role', 'option', 'value', 'infusion'), null);
        ...
        this._MdPrefixRejector_45_4 = new import14.Wrapper_MdPrefixRejector(this.parentView.injectorGet(import18.MATERIAL_COMPATIBILITY_MODE, this.parentIndex, null));
        this._text_46 = this.renderer.createText(null, 'Infusion', null);
        this.compView_45.create(this._MdOption_45_3.context);
        this._text_47 = this.renderer.createText(null, '\n			', null);
        this._el_48 = import3.createRenderElement(this.renderer, null, 'md-option', new import3.InlineArray4(4, 'role', 'option', 'value', 'subcutaneous'), null);
        ...
        this._MdPrefixRejector_48_4 = new import14.Wrapper_MdPrefixRejector(this.parentView.injectorGet(import18.MATERIAL_COMPATIBILITY_MODE, this.parentIndex, null));
        this._text_49 = this.renderer.createText(null, 'Subcutaneous', null);
        ...
        this._anchor_52 = this.renderer.createTemplateAnchor(this._el_2, null);
        ...
        this._anchor_54 = this.renderer.createTemplateAnchor(this._el_2, null);
        ...
        this._el_56 = import3.createRenderElement(this.renderer, this._el_2, 'div', new import3.InlineArray2(2, 'style', 'text-align:center;margin-top:10px;'), null);
        this._text_57 = this.renderer.createText(this._el_56, '\n			', null);
        this._el_58 = import3.createRenderElement(this.renderer, this._el_56, 'button', new import3.InlineArray4(4, 'md-raised-button', '', 'type', 'submit'), null);
        this.compView_58 = new import43.View_MdButton0(this.viewUtils, this, 58, this._el_58);
        this._MdPrefixRejector_58_3 = new import14.Wrapper_MdPrefixRejector(this.parentView.injectorGet(import18.MATERIAL_COMPATIBILITY_MODE, this.parentIndex, null));
        ...
        this._text_59 = this.renderer.createText(null, 'Save', null);
        this.compView_58.create(this._MdButton_58_4.context);
        this._text_60 = this.renderer.createText(this._el_56, '\n			', null);
        this._el_61 = import3.createRenderElement(this.renderer, this._el_56, 'a', new import3.InlineArray2(2, 'md-button', ''), null);
        this.compView_61 = new import43.View_MdAnchor0(this.viewUtils, this, 61, this._el_61);
        this._MdPrefixRejector_61_3 = new import14.Wrapper_MdPrefixRejector(this.parentView.injectorGet(import18.MATERIAL_COMPATIBILITY_MODE, this.parentIndex, null));
        ...
        this._text_62 = this.renderer.createText(null, 'Cancel', null);
        ...
        var disposable_16 = import3.subscribeToRenderElement(this, this._el_43, new import3.InlineArray8(6, 'ngModelChange', null, 'keydown', null, 'blur', null), this.eventHandler(this.handleEvent_43));
        this._NgModel_43_5.subscribe(this, this.eventHandler(this.handleEvent_43), true);
        var disposable_17 = import3.subscribeToRenderElement(this, this._el_45, new import3.InlineArray4(4, 'click', null, 'keydown', null), this.eventHandler(this.handleEvent_45));
        var disposable_18 = import3.subscribeToRenderElement(this, this._el_48, new import3.InlineArray4(4, 'click', null, 'keydown', null), this.eventHandler(this.handleEvent_48));
        var disposable_19 = import3.subscribeToRenderElement(this, this._el_58, new import3.InlineArray8(6, 'mousedown', null, 'focus', null, 'blur', null), this.eventHandler(this.handleEvent_58));
        var disposable_20 = import3.subscribeToRenderElement(this, this._el_61, new import3.InlineArray8(8, 'click', null, 'mousedown', null, 'focus', null, 'blur', null), this.eventHandler(this.handleEvent_61));
    ...
    View_PatientProfileComponent0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        ...
        if (((token === import47.NG_VALUE_ACCESSOR) && (6 === requestNodeIndex))) {
            return this._NG_VALUE_ACCESSOR_6_6;
        }
        if (((token === import33.NgModel) && (6 === requestNodeIndex))) {
            return this._NgModel_6_7.context;
        }
        if (((token === import34.NgControl) && (6 === requestNodeIndex))) {
            return this._NgControl_6_8;
        }
        if (((token === import35.NgControlStatus) && (6 === requestNodeIndex))) {
            return this._NgControlStatus_6_9.context;
        }
        if (((token === import37.MdInputDirective) && (6 === requestNodeIndex))) {
            return this._MdInputDirective_6_10.context;
        }
        if (((token === import37.MdInputContainer) && ((4 <= requestNodeIndex) && (requestNodeIndex <= 7)))) {
            return this._MdInputContainer_4_3.context;
        }
        if (((token === import46.DefaultValueAccessor) && (11 === requestNodeIndex))) {
            return this._DefaultValueAccessor_11_3.context;
        }
        if (((token === import31.RequiredValidator) && (11 === requestNodeIndex))) {
            return this._RequiredValidator_11_4.context;
        }
        if (((token === import32.NG_VALIDATORS) && (11 === requestNodeIndex))) {
            return this._NG_VALIDATORS_11_5;
        }
        if (((token === import47.NG_VALUE_ACCESSOR) && (11 === requestNodeIndex))) {
        ...
        if (((token === import37.MdInputDirective) && (11 === requestNodeIndex))) {
            return this._MdInputDirective_11_10.context;
        }
        if (((token === import37.MdInputContainer) && ((9 <= requestNodeIndex) && (requestNodeIndex <= 12)))) {
            return this._MdInputContainer_9_3.context;
        }
        if (((token === import46.DefaultValueAccessor) && (16 === requestNodeIndex))) {
            return this._DefaultValueAccessor_16_3.context;
        }
        if (((token === import31.RequiredValidator) && (16 === requestNodeIndex))) {
            return this._RequiredValidator_16_4.context;
        }
        if (((token === import32.NG_VALIDATORS) && (16 === requestNodeIndex))) {
            return this._NG_VALIDATORS_16_5;
        }
        if (((token === import47.NG_VALUE_ACCESSOR) && (16 === requestNodeIndex))) {
            return this._NG_VALUE_ACCESSOR_16_6;
        }
        if (((token === import33.NgModel) && (16 === requestNodeIndex))) {
            return this._NgModel_16_7.context;
        }
        if (((token === import34.NgControl) && (16 === requestNodeIndex))) {
            return this._NgControl_16_8;
        }
        if (((token === import35.NgControlStatus) && (16 === requestNodeIndex))) {
            return this._NgControlStatus_16_9.context;
        }
        if (((token === import37.MdInputDirective) && (16 === requestNodeIndex))) {
            return this._MdInputDirective_16_10.context;
        }
        if (((token === import37.MdInputContainer) && ((14 <= requestNodeIndex) && (requestNodeIndex <= 17)))) {
        ...
        if (((token === import31.RequiredValidator) && (21 === requestNodeIndex))) {
            return this._RequiredValidator_21_4.context;
        }
        if (((token === import32.NG_VALIDATORS) && (21 === requestNodeIndex))) {
            return this._NG_VALIDATORS_21_5;
        }
        if (((token === import47.NG_VALUE_ACCESSOR) && (21 === requestNodeIndex))) {
            return this._NG_VALUE_ACCESSOR_21_6;
        }
        if (((token === import33.NgModel) && (21 === requestNodeIndex))) {
            return this._NgModel_21_7.context;
        }
        if (((token === import34.NgControl) && (21 === requestNodeIndex))) {
            return this._NgControl_21_8;
        }
        if (((token === import35.NgControlStatus) && (21 === requestNodeIndex))) {
            return this._NgControlStatus_21_9.context;
        }
        if (((token === import37.MdInputDirective) && (21 === requestNodeIndex))) {
            return this._MdInputDirective_21_10.context;
        }
        if (((token === import37.MdInputContainer) && ((19 <= requestNodeIndex) && (requestNodeIndex <= 22)))) {
            return this._MdInputContainer_19_3.context;
        }
        if (((token === import46.DefaultValueAccessor) && (26 === requestNodeIndex))) {
            return this._DefaultValueAccessor_26_3.context;
        }
        if (((token === import48.NumberValueAccessor) && (26 === requestNodeIndex))) {
            return this._NumberValueAccessor_26_4.context;
        }
        if (((token === import31.RequiredValidator) && (26 === requestNodeIndex))) {
            return this._RequiredValidator_26_5.context;
        }
        if (((token === import32.NG_VALIDATORS) && (26 === requestNodeIndex))) {
            return this._NG_VALIDATORS_26_6;
        }
        if (((token === import47.NG_VALUE_ACCESSOR) && (26 === requestNodeIndex))) {
            return this._NG_VALUE_ACCESSOR_26_7;
        }
        if (((token === import33.NgModel) && (26 === requestNodeIndex))) {
            return this._NgModel_26_8.context;
        }
        if (((token === import34.NgControl) && (26 === requestNodeIndex))) {
            return this._NgControl_26_9;
        }
        if (((token === import35.NgControlStatus) && (26 === requestNodeIndex))) {
            return this._NgControlStatus_26_10.context;
        }
        if (((token === import37.MdInputDirective) && (26 === requestNodeIndex))) {
            return this._MdInputDirective_26_11.context;
        }
        if (((token === import37.MdInputContainer) && ((24 <= requestNodeIndex) && (requestNodeIndex <= 27)))) {
            return this._MdInputContainer_24_3.context;
        }
        if (((token === import12.MdOption) && ((31 <= requestNodeIndex) && (requestNodeIndex <= 32)))) {
            return this._MdOption_31_3.context;
        }
        if (((token === import18.MdPrefixRejector) && ((31 <= requestNodeIndex) && (requestNodeIndex <= 32)))) {
            return this._MdPrefixRejector_31_4.context;
        }
        if (((token === import12.MdOption) && ((34 <= requestNodeIndex) && (requestNodeIndex <= 35)))) {
            return this._MdOption_34_3.context;
        }
        if (((token === import18.MdPrefixRejector) && ((34 <= requestNodeIndex) && (requestNodeIndex <= 35)))) {
            return this._MdPrefixRejector_34_4.context;
        }
        if (((token === import31.RequiredValidator) && ((29 <= requestNodeIndex) && (requestNodeIndex <= 36)))) {
            return this._RequiredValidator_29_3.context;
        }
        if (((token === import32.NG_VALIDATORS) && ((29 <= requestNodeIndex) && (requestNodeIndex <= 36)))) {
            return this._NG_VALIDATORS_29_4;
        }
        if (((token === import33.NgModel) && ((29 <= requestNodeIndex) && (requestNodeIndex <= 36)))) {
            return this._NgModel_29_5.context;
        }
        if (((token === import34.NgControl) && ((29 <= requestNodeIndex) && (requestNodeIndex <= 36)))) {
            return this._NgControl_29_6;
        }
        if (((token === import35.NgControlStatus) && ((29 <= requestNodeIndex) && (requestNodeIndex <= 36)))) {
            return this._NgControlStatus_29_7.context;
        }
        if (((token === import18.MdPrefixRejector) && ((29 <= requestNodeIndex) && (requestNodeIndex <= 36)))) {
            return this._MdPrefixRejector_29_8.context;
        }
        if (((token === import19.MdSelect) && ((29 <= requestNodeIndex) && (requestNodeIndex <= 36)))) {
            return this._MdSelect_29_9.context;
        }
        if (((token === import46.DefaultValueAccessor) && (40 === requestNodeIndex))) {
            return this._DefaultValueAccessor_40_3.context;
        }
        if (((token === import48.NumberValueAccessor) && (40 === requestNodeIndex))) {
            return this._NumberValueAccessor_40_4.context;
        }
        if (((token === import31.RequiredValidator) && (40 === requestNodeIndex))) {
            return this._RequiredValidator_40_5.context;
        }
        if (((token === import32.NG_VALIDATORS) && (40 === requestNodeIndex))) {
            return this._NG_VALIDATORS_40_6;
        }
        if (((token === import47.NG_VALUE_ACCESSOR) && (40 === requestNodeIndex))) {
            return this._NG_VALUE_ACCESSOR_40_7;
        }
        if (((token === import33.NgModel) && (40 === requestNodeIndex))) {
            return this._NgModel_40_8.context;
        }
        if (((token === import34.NgControl) && (40 === requestNodeIndex))) {
            return this._NgControl_40_9;
        }
        if (((token === import35.NgControlStatus) && (40 === requestNodeIndex))) {
            return this._NgControlStatus_40_10.context;
        }
        if (((token === import37.MdInputDirective) && (40 === requestNodeIndex))) {
            return this._MdInputDirective_40_11.context;
        }
        if (((token === import37.MdInputContainer) && ((38 <= requestNodeIndex) && (requestNodeIndex <= 41)))) {
            return this._MdInputContainer_38_3.context;
        }
        if (((token === import12.MdOption) && ((45 <= requestNodeIndex) && (requestNodeIndex <= 46)))) {
            return this._MdOption_45_3.context;
        }
        if (((token === import18.MdPrefixRejector) && ((45 <= requestNodeIndex) && (requestNodeIndex <= 46)))) {
            return this._MdPrefixRejector_45_4.context;
        }
        if (((token === import12.MdOption) && ((48 <= requestNodeIndex) && (requestNodeIndex <= 49)))) {
            return this._MdOption_48_3.context;
        }
        if (((token === import18.MdPrefixRejector) && ((48 <= requestNodeIndex) && (requestNodeIndex <= 49)))) {
            return this._MdPrefixRejector_48_4.context;
        }
        if (((token === import31.RequiredValidator) && ((43 <= requestNodeIndex) && (requestNodeIndex <= 50)))) {
            return this._RequiredValidator_43_3.context;
        }
        if (((token === import32.NG_VALIDATORS) && ((43 <= requestNodeIndex) && (requestNodeIndex <= 50)))) {
            return this._NG_VALIDATORS_43_4;
        }
        if (((token === import33.NgModel) && ((43 <= requestNodeIndex) && (requestNodeIndex <= 50)))) {
            return this._NgModel_43_5.context;
        }
        if (((token === import34.NgControl) && ((43 <= requestNodeIndex) && (requestNodeIndex <= 50)))) {
            return this._NgControl_43_6;
        }
        if (((token === import35.NgControlStatus) && ((43 <= requestNodeIndex) && (requestNodeIndex <= 50)))) {
            return this._NgControlStatus_43_7.context;
        }
        if (((token === import18.MdPrefixRejector) && ((43 <= requestNodeIndex) && (requestNodeIndex <= 50)))) {
            return this._MdPrefixRejector_43_8.context;
        }
        if (((token === import19.MdSelect) && ((43 <= requestNodeIndex) && (requestNodeIndex <= 50)))) {
            return this._MdSelect_43_9.context;
        }
        if (((token === import28.TemplateRef) && (52 === requestNodeIndex))) {
            return this._TemplateRef_52_5;
        }
        if (((token === import49.NgIf) && (52 === requestNodeIndex))) {
            return this._NgIf_52_6.context;
        }
        if (((token === import28.TemplateRef) && (54 === requestNodeIndex))) {
            return this._TemplateRef_54_5;
        }
        if (((token === import49.NgIf) && (54 === requestNodeIndex))) {
            return this._NgIf_54_6.context;
        }
        if (((token === import18.MdPrefixRejector) && ((58 <= requestNodeIndex) && (requestNodeIndex <= 59)))) {
            return this._MdPrefixRejector_58_3.context;
        }
        if (((token === import42.MdButton) && ((58 <= requestNodeIndex) && (requestNodeIndex <= 59)))) {
            return this._MdButton_58_4.context;
        }
        if (((token === import42.MdRaisedButtonCssMatStyler) && ((58 <= requestNodeIndex) && (requestNodeIndex <= 59)))) {
            return this._MdRaisedButtonCssMatStyler_58_5.context;
        }
        if (((token === import18.MdPrefixRejector) && ((61 <= requestNodeIndex) && (requestNodeIndex <= 62)))) {
            return this._MdPrefixRejector_61_3.context;
        }
        if (((token === import42.MdAnchor) && ((61 <= requestNodeIndex) && (requestNodeIndex <= 62)))) {
            return this._MdAnchor_61_4.context;
        }
        if (((token === import42.MdButtonCssMatStyler) && ((61 <= requestNodeIndex) && (requestNodeIndex <= 62)))) {
            return this._MdButtonCssMatStyler_61_5.context;
        }
        if (((token === import50.NgForm) && ((2 <= requestNodeIndex) && (requestNodeIndex <= 64)))) {
            return this._NgForm_2_3.context;
        }
        if (((token === import51.ControlContainer) && ((2 <= requestNodeIndex) && (requestNodeIndex <= 64)))) {
            return this._ControlContainer_2_4;
        }
        if (((token === import35.NgControlStatusGroup) && ((2 <= requestNodeIndex) && (requestNodeIndex <= 64)))) {
    ...
    View_PatientProfileComponent0.prototype.detectChangesInternal = function (throwOnChange) {
        ...
        valUnwrapper.reset();
        var currVal_16_2_1 = valUnwrapper.unwrap(import3.castByValue(this._pipe_date_0_0, this._pipe_date_0.transform)(this.context.pp.patient.dob, 'yyyy-MM-dd'));
        ...
        var currVal_43_1_0 = 'insulinDeliveryType';
        this._NgModel_43_5.check_name(currVal_43_1_0, throwOnChange, false);
        var currVal_43_1_1 = this.context.pp.patient.profile.insulinDeliveryType;
        ...
        var currVal_43_4_0 = 'Insulin Delivery Type';
        ...
        var currVal_48_0_0 = 'subcutaneous';
        ...
        var currVal_52_0_0 = ((this.context.pp.patient.profile.insulinDeliveryType == 'subcutaneous') && this.context.pp.patient.profile.subcutaneousColumn);
        ...
        var currVal_54_0_0 = ((this.context.pp.patient.profile.insulinDeliveryType == 'infusion') && this.context.pp.patient.profile.infusionColumn);
        ...
        var currVal_58_1_0 = !this._NgForm_2_3.context.form.valid;
        this._MdButton_58_4.check_disabled(currVal_58_1_0, throwOnChange, false);
        if (this._MdButton_58_4.ngDoCheck(this, this._el_58, throwOnChange)) {
        ...
        if (!throwOnChange) {
            ...
            if ((this.numberOfChecks === 0)) {
                this._MdSelect_43_9.context.ngAfterContentInit();
            }
        }
    ...
    View_PatientProfileComponent0.prototype.createEmbeddedViewInternal = function (nodeIndex) {
        if ((nodeIndex == 52)) {
            return new View_PatientProfileComponent1(this.viewUtils, this, 52, this._anchor_52, this._vc_52);
        }
        if ((nodeIndex == 54)) {
            return new View_PatientProfileComponent3(this.viewUtils, this, 54, this._anchor_54, this._vc_54);
        }
        return null;
    };
    ...
    View_PatientProfileComponent0.prototype.handleEvent_43 = function (eventName, $event) {
        this.compView_43.markPathToRootAsCheckOnce();
        var result = true;
        result = (this._MdSelect_43_9.handleEvent(eventName, $event) && result);
        if ((eventName == 'ngModelChange')) {
            var pd_sub_0 = ((this.context.pp.patient.profile.insulinDeliveryType = $event) !== false);
            result = (pd_sub_0 && result);
        }
        return result;
    };
    ...
    View_PatientProfileComponent0.prototype.handleEvent_58 = function (eventName, $event) {
        this.compView_58.markPathToRootAsCheckOnce();
        var result = true;
        result = (this._MdButton_58_4.handleEvent(eventName, $event) && result);
        return result;
    };
    View_PatientProfileComponent0.prototype.handleEvent_61 = function (eventName, $event) {
...
export { View_PatientProfileComponent0 };
